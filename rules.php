...
<a href="mybooking.php"><h2 class="w3-text-blue" style="float: left"> Hi <?php echo $_SESSION['userData']['first_name']; ?></h2></a><h2 style="float:right; color: white;"><a href="login/logout.php">LOGOUT</a></h2>  <div class="w3-container">
  ...
  <h2 class="w3-text-blue"><strong>Rules</strong></h2>
    <p class="w3-light-grey"> The use of a Carlelo vehicle under the following conditions is prohibited:</p>
    <ul class="w3-light-grey" style="list-style-type:square">
      <li>Any speed race or competition</li>
      <li>For the purpose of towing, pushing, or propelling any trailer or any other vehicle</li>
      <li>For the primary business purpose of transporting people or operating a taxi service</li>
      <li>By any person who is under the influence of (i) alcohol or (ii) any drug or medication under the effects of which the operation of a vehicle is prohibited or not recommended. A zero-tolerance policy is adopted and a limit of 0.0% applies</li>
      <li>In the carrying out of any crime or any other illegal activity;</li>
      <li>Driving the vehicle outside of India or any prohibited areas within India</li>
      <li>Driving while using a mobile phone or any other mobile communication device in any manner whatsoever, including while sending an SMS, emailing, using a cell phone with or without a hands-free device, otherwise using a mobile communication device that may distract you from driving or otherwise engaging in similar activities that may be prohibited by applicable law</li>
      <li>Transporting more passengers than the prescribed seating capacity of the vehicle by manufacturer of the vehicle.</li>
    </ul>
  <hr>
